...
public class _TestModule {
	...
	public static void main(String[] args) {
		...
		KuramotoManage um = new KuramotoManage(K, dt);
		for(int i = 0; i < num; i++) {
	...
	private static String getWriteData_naturalWave(ArrayList<Kuramoto> array) {
		String r = "";
		for(Kuramoto e: array) {
			r = r + Math.sin(e.getWavePrm()) + " ";
		}
		return r;
	}
	
	private static String getWriteData_Unit(ArrayList<Kuramoto> array) {
		String r = "";
		for(Kuramoto e: array) {
